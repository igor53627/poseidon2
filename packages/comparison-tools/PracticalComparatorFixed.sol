 ...
 */
contract PracticalComparatorFixed is Test {
    ...
    /**
     * @notice Compare implementations with the same input
     */
    ...
    function runComprehensiveBenchmark() public returns (string memory) {
        ...
        // Generate report
        return _generateBenchmarkReport(sizeResults);
    }
    ...
    function _generateBenchmarkReport(ComparisonResult[] memory sizeResults) internal view returns (string memory) {
