...
/**
 * @title Deployed Gas Test
 * @notice Gas testing with deployed contract instances
 */
contract DeployedGasTest {
    ...
    function testZemseGas() public returns (uint256 gasUsed, uint256 result) {
        ...
        Field.Type output = zemseImpl.hash(zemseInput, zemseInput.length, false);
